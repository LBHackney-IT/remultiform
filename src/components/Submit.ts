...
/**
 * The proptypes for {@link PageProps.Submit}.
 */
export interface SubmitProps {
   ...
   * implementation of {@link PageProps.Submit} must catch any exceptions
...
/**
 * The type of a component for submitting a {@link Step}.
 */
